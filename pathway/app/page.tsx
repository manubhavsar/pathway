    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <DashboardHeader
          ...
          userName={userMockData.name}
          userEmail={userMockData.email}
          userAvatar={userMockData.avatar}
        />
          ...
          <div className="grid auto-rows-min gap-4 md:grid-cols-3">
            <div className="aspect-video rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 p-6 text-white md:col-span-2">
              <div className="flex flex-col justify-between h-full">
                <div>
                  <h1 className="text-2xl font-bold mb-2">Welcome back, {userMockData.name.split(" ")[0]}! 👋</h1>
                  <div className="mb-4">
